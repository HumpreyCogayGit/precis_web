...
const RATE_LIMITS = {
  ...
  // Its own bucket, and a tighter one: a search is two queries against the whole
  // archive rather than one indexed read of the working set, and the client only
  // calls it on a deliberate Enter, not per keystroke.
  search: { name: 'search', windowMs: 60 * 1000, max: 60 },
